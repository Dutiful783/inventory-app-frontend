      ...
      <section className='container hero'>
        <div className='hero-text'>
          ...
          <div className='hero-buttons'>
            <button className='--btn --btn-secondary'><Link to="/dashboard" >Free trial 1 Month</Link></button>
          </div>
          <div className='--flex-start'>
            <NumberTest num="14K" text="Brand Owners" />
            <NumberTest num="23K" text="Active Users" />
            <NumberTest num="500+" text="Partners" />
          </div>
        </div>
